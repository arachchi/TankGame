...
public class ElementPainter {
    ...
    public ElementPainter(Map map, Image brickImage, Image stoneImage, Image waterImage, Player myPlayer, Image lpImage, Image cpImage,Image bullet) {
        ...
        worriorNames=new String[5];
        worriorNames[0]="Leonardo";
        worriorNames[1]="Casey";
        worriorNames[2]="Michelangelo";
        worriorNames[3]="Donatello";
        worriorNames[4]="Paphael";
...
//////            myPlayerImage.draw(playerDataConverter(Player.getPlayerX()), playerDataConverter(Player.getPlayerY()));
    ...
    private void drawSideBar(){
        ...
        ttfTitle.drawString(950, 22, "Char De Combat", Color.yellow) ;
        ...
        ttfScore.drawString(tableX + width * 0, tableY + (myPlayer.getIndex() * height), "Splinter", Color.yellow);
        ttfScore.drawString(tableX + width * 2, tableY + (myPlayer.getIndex() * height), Integer.toString(myPlayer.getCoins()), Color.yellow);
        ttfScore.drawString(tableX + width * 4, tableY+(myPlayer.getIndex()*height),Integer.toString(myPlayer.getHealth()), Color.yellow);
...
//        
        ...
        if (playerIter.hasNext()) {
            ...
            while ((player) != null) {
               ...
               ttfScore.drawString( tableX + width*0, tableY+(player.getIndex()*height),worriorNames[player.getIndex()], Color.lightGray);
