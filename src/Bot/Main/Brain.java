...
public class Brain implements Runnable{
    ...
    public void run() {
       ...
       commanderStart();//start the commander who is doing the whole AI
        while(!stop){
            ...
            if(((currentStates.getOtherBots()==null||currentStates.getOtherBots().isEmpty()))&&((currentStates.getCoinPiles()).isEmpty())&&((currentStates.getHealthPacks()).isEmpty())){
              currentStates.setMode(0);
                ...
                currentStates.setMode(1);//this should be changed
            }
                ...
                currentStates.setMode(3);   //intial value 3 changed to 2
